...
---
  ...
  it, I wanted to see whether I could simplify my approach while keeping it accurate.

  When I start a new project, whether it's an app or a website, I create two documents: `features.md` and `evals.md`.

  Since I started using `evals.md`, I've been taking a shortcut: I let the LLM generate it for me. That isn't
  good enough.
  ...
  2. Prefer objective, deterministic graders—such as pass/fail or true/false—when the expected result is
     unambiguous.
